...
export default function SignUp() {
  ...
  function onSubmit(event) {
    ...
    if (!emailPattern.test(userName) || !passwordPattern.test(password) || confirmPassword !== password) {
      return;
    }
  ...
  function setConfirmPasswordAndError(value) {
    ...
    if (value === '') {
      ...
      setConfirmPasswordError('Please enter same confirm password which you enter in password field');
    } else {
            ...
            <form onSubmit={onSubmit}>
              ...
              <div className='mb-3'>
                ...
                <input
                  ...
                  onChange={(event) => setConfirmPasswordAndError(event.target.value)}
                  onBlur={(event) => setConfirmPasswordAndError(event.target.value)}
                />
